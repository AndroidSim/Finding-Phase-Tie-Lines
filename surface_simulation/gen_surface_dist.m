function [FRET_surface]=gen_surface_dist(exp_surface,tielines,xdonr,xaceptr,kpdonr,kpaceptr,expconsta,expconstb)
...
FRET_surface=griddata(xcoord,ycoord,zfret,X,Y)';